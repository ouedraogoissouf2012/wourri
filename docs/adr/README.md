...
| [ADR-0031](0031-moteur-amelioration-linguistique.md) | Moteur d'amélioration linguistique (statuts, rôles, publication) | **proposé** | 2026-08-16 | #429 / epic #428. **Option A** : Convex = atelier (Bronze→Production, 1 locuteur = 1 langue) ; pgvector = runtime Or+ seulement. Auth = #372. Admin = sas avant corpus. Pas de 2ᵉ auth FastAPI. |
