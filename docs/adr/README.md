...
| [ADR-0010](0010-migration-monorepo.md) | Migration vers monorepo | **remplacé** ([0037](0037-conserver-multibranches-orphelines.md)) | 2026-04-23 | Structure repo (3 branches orphelines) → monorepo. **Accepté en avril, non exécuté 4 mois → remplacé par [ADR-0037](0037-conserver-multibranches-orphelines.md)** (on conserve le multi-branches). Dette #489. |
...
| [ADR-0037](0037-conserver-multibranches-orphelines.md) | Conserver le multi-branches orphelines (n'exécute pas ADR-0010) | **accepté** | 2026-08-27 | Dette #489. ADR-0010 (monorepo) accepté en avril, non exécuté 4 mois → **remplacé**. Le pattern 3-branches (CI par branche, Dokploy par service) fonctionne ; migration monorepo coûteuse/risquée non justifiée. Dette résiduelle assumée (Dependabot sur branche par défaut). Réversible. |
