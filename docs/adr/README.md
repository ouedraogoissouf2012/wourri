...
| [ADR-0025](0025-retention-logs-pii-artci.md) | Rétention et purge des logs PII (conformité ARTCI) | **accepté** | 2026-08-14 | Issue #215 : fichiers de log datés append-only (aucun rename, sûr multi-worker) + purge quotidienne in-app. Logs applicatifs 30 j, feedback pseudonymisé 365 j, volume `wa_logs` mort supprimé. Politique : [docs/compliance/artci-logs.md](../compliance/artci-logs.md). |
