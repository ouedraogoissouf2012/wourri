...
| [ADR-0003](0003-plan-ajout-omnilingual.md) | Plan d'ajout Omnilingual | **proposé** | 2026-04-22 | 5 phases : env → provider → benchmark → intégration → cleanup. |
| [ADR-0005](0005-afrolid-language-detection.md) | Détection de langue textuelle via AfroLID | **proposé** | 2026-04-23 | AfroLID (UBC-NLP, Apache 2.0, 517 langues africaines) pour remplacer l'heuristique hardcodée `is_likely_dioula_input`. Implémentation différée P2-P3. |
