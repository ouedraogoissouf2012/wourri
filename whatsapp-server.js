...
function initializeWhatsApp() {
    client = new Client({
        authStrategy: new LocalAuth({ name: "ecole-notification" }),
        puppeteer: { 
            headless: true,
            args: [
                '--no-sandbox',
...
app.get('/qr-page', (req, res) => {
    if (!qrCodeData) {
        ...
        // Afficher le QR code en ASCII art directement dans la page
...
function generateQRCodeAscii(data) {
    // Utiliser la bibliothèque qrcode-terminal pour générer l'ASCII
    const qrcode = require('qrcode-terminal');
    let qrString = '';
    
    // Capturer la sortie du QR code
    ...
    // Restaurer la fonction d'écriture originale
